...
//TODO: if names is unprocessed it doesn't work - need to process
        ...
        if(chooseDB.getSelectionModel().getSelectedItem().equals("Add new...")) {
            ...
            if (selectedDirectory != null) {
                ...
                if(verifyDB(selectedDirectory.getPath())) {
                    ...
                    PopupWindow p = new PopupWindow("model/views/InvalidDB.fxml", true, "", (Stage) backBtn.getScene().getWindow());
                }
            }
        }
    }
